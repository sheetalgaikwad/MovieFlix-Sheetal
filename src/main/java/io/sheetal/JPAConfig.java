...
public class JPAConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(){
		...
		emf.setPackagesToScan(new String[] {"io.sheetal.entity"});
	...
	public Properties jpaProperties(){
		...
		props.put("hibernate.hbm2ddl.format_sql", env.getProperty("hibernate.format_sql"));
		props.put("hibernate.hbm2ddl.show_sql", env.getProperty("hibernate.show_sql"));
		return props;
	}
}
